	...
	<div class="banner">
		...
		<div class="content">
			<form action="" method="POST">
				<h1>Register</h1>
				<input class="txtbox" placeholder="Enter your Name" type="text" name="name"/><br>
				<input class="txtbox" placeholder="Enter your Mail ID" type="text" name="mail"/><br>
				<input class="txtbox" placeholder="Enter your Mobile Number" type="text" name="mob"/><br>
			...
			<p>Have an Account? <a href="login.php" style="color: blue;text-decoration: none;">Login</a></p>
		</div>
	</div>
</body>
</html>